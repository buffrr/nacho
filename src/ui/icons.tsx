...
export function Telegram({ size = 20, color = "#229ED9" }: IconProps) {
  // Plane-only glyph (the squircle supplies the blue), matching the modern icon.
  return (
    <Frame size={size} vb={24}>
      <Path
...
export function NostrN({ size = 20, color = "#FFFFFF" }: IconProps) {
  // Nostr shown as a bold lowercase "n" on its purple gradient squircle.
  return (
    <Frame size={size} vb={24}>
      <SvgText
        x={12}
...
export function Bluesky({ size = 20, color = "#FFFFFF" }: IconProps) {
  // Official Bluesky butterfly (the squircle supplies the blue).
  return (
    <Frame size={size} vb={24}>
      <Path
